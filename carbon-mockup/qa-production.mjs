...
await page.locator('#carbon-theme-select').selectOption('theme-retro');
...
await page.locator('#carbon-theme-select').waitFor();
expect(await page.evaluate(()=>window.sitePreferences.analyticsTheme())).toBe('carbon-dark');
await page.locator('#carbon-language-select').selectOption('pt');
